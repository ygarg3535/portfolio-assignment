                ...
                return (
                  <li key={index}>
                    <div
                      ...
                      <Link activeClass="active" to={navMenu.link} spy={true} smooth={true} offset={0} duration={800} >{navMenu.name}</Link>
                    </div>
                  </li>
                );
              })}
                    ...
                    return (
                      <li key={index}>
                        <div
                          className="text-xl font-semibold px-2 py-4 md:py-6 inline-block cursor-pointer"
                        >
                        <Link onClick={() => setShowMenu(false)} activeClass="active" to={navMenu.link} spy={true} smooth={true} offset={0} duration={800} >{navMenu.name}</Link>
                        </div>
                      </li>
                    );
                  })}
