      ...
      <div className="container md:w-[70%] sm:py-16 py-10">
        <div className="grid items-center gap-4 grid-cols-1 sm:grid-cols-2">
          ...
          <div className="text-slate-500 sm:order-1">
            <SkillsLevel skillsName="HTML, CSS , JavaScript" percentage="90%" />
            <SkillsLevel skillsName="React" percentage="80%" />
            <SkillsLevel skillsName="Tailwind CSS" percentage="85%" />
            <SkillsLevel skillsName="Spring Boot" percentage="75%" />
